...
{
    if (str == "GET") return HttpMethod::hGet;
    if (str == "POST") return HttpMethod::hPost;
    if (str == "PUT") return HttpMethod::hPut;
    if (str == "DELETE") return HttpMethod::hDelete;
    if (str == "PATCH") return HttpMethod::hPatch;
    if (str == "HEAD") return HttpMethod::hHead;
    if (str == "OPTIONS") return HttpMethod::hOptions;
    return HttpMethod::hUnknown;
}
