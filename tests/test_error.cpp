...
TEST(ErrorCodeTest, ErrorCodeToString)
{
    ...
    EXPECT_STREQ(errorCodeToString(ErrorCode::hConnectionReset),
                 "Connection reset by peer");
    EXPECT_STREQ(errorCodeToString(ErrorCode::hTimedOut),
                 "Connection timed out");
    EXPECT_STREQ(errorCodeToString(ErrorCode::hOperationAborted),
                 "Operation aborted");
