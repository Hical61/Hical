...
oatpp::Object<MiddlewareDTO> runWithMiddleware(
    int layers,
    std::function<oatpp::Object<MiddlewareDTO>()> handler)
{
...
public:
    ...
    {
        auto result = runWithMiddleware(3, []() -> oatpp::Object<MiddlewareDTO>
            {
                auto dto = MiddlewareDTO::createShared();
    ...
    {
        auto result = runWithMiddleware(10, []() -> oatpp::Object<MiddlewareDTO>
            {
                auto dto = MiddlewareDTO::createShared();
...
int main()
{
    ...
    auto connectionProvider = oatpp::network::tcp::server::ConnectionProvider::createShared(
        {"0.0.0.0", 8085, oatpp::network::Address::IP_4});
