...
curl -LO https://github.com/Hical61/Hical/releases/download/v2.7.0/hical-2.7.0-conan-src.tar.gz
tar xzf hical-2.7.0-conan-src.tar.gz && cd hical
conan export . --version=2.7.0
```
