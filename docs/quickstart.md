...
curl -LO https://github.com/Hical61/Hical/releases/download/v2.6.3/hical-2.6.3-conan-src.tar.gz
tar xzf hical-2.6.3-conan-src.tar.gz && cd hical
conan export . --version=2.6.3
```
